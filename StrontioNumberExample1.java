...
public class StrontioNumberExample1 {
	...
	public static void main(String[] args) {
		...
		int num = sc.nextInt();
		int n = num;
		//first, we hava multipplied a number by 2
		//the result is divided by 1000 that gives the remainder and remove the first digit
		//at last, the result is divided by 10 that remove the last digit
		//therefore, we get a two-digit number that are mean digit of the given number
		num = (num*2%1000)/10;
